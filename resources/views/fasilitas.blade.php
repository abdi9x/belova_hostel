        ...
        <section class="about_benefits section" style="margin-bottom: 0px;">
            <div class=container>
                ...
                <!-- <div class=about_benefits-video data-aos=fade-in>
                    <picture>
                        <source data-srcset=img/about/video.jpg srcset=img/about/video.jpg><img class=lazy data-src=img/about/video.jpg src=img/about/video.jpg alt=media>
                    </picture><a class="video-play d-inline-flex align-items-center justify-content-center" href=#><i class="icon-play icon"></i></a>
                </div> -->
            </div>
        </section>
        <!-- <section class="about_stages section mt-0">
            <div class="container d-xl-flex align-items-center">
                <div class="about_stages-main col-xl-6">
                    ...
                    <div class=wrapper data-aos=fade-up><a class="about_stages-main_btn btn theme-element theme-element--accent" href=#>Choose room</a>
                    </div>
                </div>
                <div class="about_stages-media col-xl-6" data-aos=fade-in>
                    <picture>
                        <source data-srcset=img/about/stages.jpg srcset=img/about/stages.jpg><img class=lazy data-src=img/about/stages.jpg src=img/about/stages.jpg alt=media>
                    </picture>
                </div>
            </div>
        </section> -->
        <section class="gallery section">
            <div class=container>
                <div class="gallery_header d-sm-flex justify-content-between align-items-center">
                    <h2 class=gallery_header-title>Fasilitas Umum</h2>
                    <div class=wrapper><a class="btn theme-element theme-element--light" href="{{route('galeri-foto')}}">Lihat Semua Foto</a></div>
                </div>
                <div class="gallery_grid d-grid">
                    @foreach($images as $image)
                    <div class="gallery_grid-item" data-aos=zoom-in>
                        <a href="{{config('app.image_path')}}{{$image->image}}" data-caption="Fasilitas Umum" data-role=gallery-link>
                            <picture>
                                <source data-srcset="{{config('app.image_path')}}{{$image->image}}" srcset="{{config('app.image_path')}}{{$image->image}}"><img class="gallery_grid-item_img lazy" data-src="{{config('app.image_path')}}{{$image->image}}" src="{{config('app.image_path')}}{{$image->image}}" alt=media>
                            </picture>
