        ...
        <div class="gallery section">
            <div class=container>
                <ul class="gallery_filters d-flex flex-wrap align-items-baseline">
                    ...
                    <li class=list-item><a data-target=public class="gallery_filters-filter underlined underlined--accent" href=#>Fasilitas Umum</a></li>
                </ul>
                <div class="gallery_masonry row g-0">
                    @foreach($images as $image)
                    <figure class="gallery_masonry-item col-sm-6 col-lg-4" data-groups='["{{$image->tag}}"]'>
                        <a class="aspect aspect--sm" href="{{config('app.image_path')}}{{$image->image}}" data-caption="Image caption" data-role=gallery-link>
                            <div class=aspect__inner>
                                <picture>
                                    <source data-srcset="{{config('app.image_path')}}{{$image->image}}" srcset="{{config('app.image_path')}}{{$image->image}}"><img class="gallery_masonry-item_img lazy" data-src="{{config('app.image_path')}}{{$image->image}}" src="{{config('app.image_path')}}{{$image->image}}" alt=media>
                                </picture>
                            </div>
                ...
                <!-- <ul class="pagination d-flex align-items-center">
                    ...
                    <li class=pagination-page><a class="pagination-page_link d-flex align-items-center justify-content-center" href=#>2</a>
                    </li>
                    <li class=pagination-page><a class="pagination-page_link d-flex align-items-center justify-content-center" href=#>3</a>
                    </li>
                </ul> -->
            </div>
        </div>
